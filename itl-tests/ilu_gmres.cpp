...
//  CVS Information:                                                         
//                                                                           
//     $RCSfile: ilu_gmres.cpp,v $  $Revision: 1.3 $  $State: Exp $ 
...
// *** empty log message ***
//
// Revision 1.1  2000/07/26 21:50:08  llee1
// change file extension from .cc to .cpp
//
// Revision 1.3  2000/07/19 19:58:00  llee1
// *** empty log message ***
//
// Revision 1.2  2000/07/18 17:44:43  llee1
// *** empty log message ***
//
...
/*
  In thsi example, we show how to use GMRES(m) algorithm
*/
...
int main (int argc, char* argv[]) 
{
  ...
  */
  ...
  cout << "before preconditioner" << endl;
  ILU<Matrix> p(A);
