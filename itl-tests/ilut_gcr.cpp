...
//  CVS Information:                                                         
//                                                                           
//     $RCSfile: ilut_gcr.cpp,v $  $Revision: 1.4 $  $State: Exp $ 
...
//
// Revision 1.3  2000/07/27 18:07:57  llee1
// *** empty log message ***
//
// Revision 1.2  2000/07/27 04:39:21  llee1
// *** empty log message ***
//
// Revision 1.1  2000/07/26 21:50:14  llee1
// change file extension from .cc to .cpp
//
// Revision 1.1  2000/07/18 16:41:02  llee1
...
#include <itl/preconditioner/ilut.h>
...
int main (int argc, char* argv[]) 
{
  ...
  ILUT<Matrix> precond(A, 1, 1.0e-6);
  //iteration
  noisy_iteration<double> iter(b, max_iter, 1e-6);
  //bicgstab algorithm
  gcr(A, x, b, precond(), 20,  iter);
  //end
