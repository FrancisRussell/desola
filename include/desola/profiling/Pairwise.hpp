...
#ifndef DESOLA_PROFILING_PAIRWISE_HPP
#define DESOLA_PROFILING_PAIRWISE_HPP
...
public:
  ...
  bool isEqual(const PPairwise& node, const std::map<const PExpressionNode<T_element>*, const PExpressionNode<T_element>*>& mappings) const
  {
